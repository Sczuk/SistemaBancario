...
public class ClienteValidationService {
    ...
    public static void validationCadastroCliente(Pessoa pessoa){ //criar a verificaçao dos cpf's
        if(ClienteValidationService.getIdade(pessoa.getDataDeNascimento()) > 17) ClienteService.cadastrarCliente(pessoa);
        if(ClienteValidationService.getIdade(pessoa.getDataDeNascimento()) < 18) ClienteService.cadastrarCliente(pessoa);
    }
